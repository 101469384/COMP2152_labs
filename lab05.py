...
while input_invalid:
    hero_name = input("Enter the Hero's name (in 2 words): ")
    hero_names = hero_name.split()

if len(hero_names) != 2:
    print("Invalid. The Hero's name must be entered in 2 words.")
elif not hero_names[0].isalpha() or not hero_name[1].isalpha():
    print("Invalid-enter name with letters only!")
else:
    input_invalid = False
...
print(f"Your health points is {health_points}.")
